...
namespace RazorPageApp.Helpers
{
    ...
    public static class ValidationHelper
    {
        ...
        public static void CopyErrorsToModelState<T>(this StatusGeneric.IStatusGeneric status, ModelStateDictionary modelState, T displayDto, string modelName = null)
        {
        ...
        public static void CopyErrorsToModelState(this StatusGeneric.IStatusGeneric status, ModelStateDictionary modelState)
        {
            if (status.IsValid) return;
        ...
        private static void CopyErrorsWithFilterOnDto<T>(IEnumerable<ValidationResult> validationResults, ModelStateDictionary modelState, T displayDto, string modelName)
        {
