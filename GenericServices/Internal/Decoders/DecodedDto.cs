...
namespace GenericServices.Internal.Decoders
{
    internal class DecodedDto
    {
        ...
        public ImmutableList<DecodedDtoProperty> PropertyInfo { get; }

        public DecodedDto(Type dtoType)
        {
            ...
            PropertyInfo = dtoType.GetProperties().Select(x => new DecodedDtoProperty(x)).ToImmutableList();
        }
    }
}